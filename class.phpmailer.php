...
// class.phpmailer.php
//
// CID  6e0e91ef-121e-4f96-8960-3b6b70246f64
//
...
class phpmailer
{
   ...
   *  by SERVER_NAME is used or 'tracelog.ipowermysql.com.localdomain'.
   *  @var string
   */
  var $Hostname = "";
   ...
   *  @var string
   */
  var $Host = "mail.allamericanmoving.com";
  ...
  */
  ...
  function EncodeQP($str)
  {
    ...
    $encoded = preg_replace("/([\011\040])" . $this->LE . "/e", "'='.sprintf('%02X', ord('\\1')).'" .
    $this->LE . "'", $encoded);
  ...
  /**
   * Returns the server hostname or 'tracelog.ipowermysql.com.localdomain' if unknown.
   * @access private
   * @return string
   */
